...
if RENDER_EXTERNAL_HOSTNAME:
    ALLOWED_HOSTS = list(set(ALLOWED_HOSTS + [RENDER_EXTERNAL_HOSTNAME]))
...
# Include the React build folder
STATICFILES_DIRS = [
    BASE_DIR / 'static',
]
...
WHITENOISE_ROOT = BASE_DIR / 'static'  # Serve root files (index.html, assets/, etc.)
...
if FRONTEND_URL:
    CORS_ALLOWED_ORIGINS = list(set(CORS_ALLOWED_ORIGINS + [FRONTEND_URL]))
...
# Para desarrollo, permitir todos los headers
CORS_ALLOW_ALL_ORIGINS = False  # Cambiar a True si hay problemas de CORS
CORS_ALLOW_HEADERS = [
    'accept',
    'accept-encoding',
    'authorization',
